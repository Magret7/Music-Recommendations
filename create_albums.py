...
#TODO
#GET FULL ARTIST LIST WE'RE USING - just the names we used ie Radiohead 
...
def create_album():
    '''
    get and add first album released by the artist (var artist) for every artist in the list artist_names
    '''
...
def show_artist_albums(artist):
    ...
    search_results = sp.search(q='artist:' + artist, type='artist', limit=1)
